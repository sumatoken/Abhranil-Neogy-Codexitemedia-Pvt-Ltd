      ...
      <div className={styles.container}>
        {/*  <main className={styles.main}>
          <p className={styles.description}>
            ...
            meet its needs. <br />
            Auric Asia has shown the innovative work which can be done within
            the sector, and we look forward to bringing this knowledge to the
            role and working collaboratively with industry and government to
            ensure the sector continues to thrive.” <br />
            We as well welcome you to contact us to experience the ultimate
            services that our clients experience when working with us. Our aim
            is to provide the highest quality, efficient delivery and
            professional services by offering unparalleled support. <br />
            Mr. Saravanan@Ram <br />
            Managing Director
          </p>
        </main> */}
