...
export default function CorporateInfo() {
  return (
    <>
      <div className="w-full h-screen bg-[#F1E5AC] pt-[100px] pb-[30px] flex flex-col items-center align-center justify-center">
        <h5 className={styles.subheading}>Corporate Information</h5>
        <table className="table-fixed corp">
          <tbody>
            <tr>
              <td className="p-[15px]">
                {" "}
            ...
            <tr>
              ...
              <td className="p-[15px]">
                ...
                <span className="text-base text-yellow-700">
                  {" "}
                  <b>
                    No.1-11, SUITE 43A, Sentral <br /> Business Suites, Jalan
                    TKS 1, <br />
