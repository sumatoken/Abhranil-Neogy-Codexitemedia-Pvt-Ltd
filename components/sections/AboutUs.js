...
export default function AboutUs() {
  return (
    <>
      <div
        className="bg-[#F1E5AC] p-[50px] h-screen"
...
for palm oil, palm products and rubber industries. <br />
...
and has extensive experience in business management.<br />
